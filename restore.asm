...
_xfer_all:
	...
	LEA	_SV_START-BASE(A4),A1
	SUBA.L	A1,A6
	MOVE.W	A6,-(A7)
	PEA	_SV_START-BASE(A4)
	JSR	_xfer
	ADDQ.W	#6,A7
	MOVE.W	#$000F,-(A7)
	...
	ADDQ.W	#6,A7
	MOVE.W	#$000E,-(A7)
	PEA	_r_guess-BASE(A4)	;_r_guess
	JSR	_xfer_strs(PC)
	ADDQ.W	#6,A7
	MOVE.W	#$000E,-(A7)
	PEA	_ws_guess-BASE(A4)	;_ws_guess
	JSR	_xfer_strs(PC)
	ADDQ.W	#6,A7
	JSR	_xfer_choice(PC)
	CLR.L	-(A7)
...
L00B44:
	...
	LEA	_CURSES_START-BASE(A4),A1
	SUBA.L	A1,A6
	MOVE.W	A6,-(A7)
	PEA	_CURSES_START-BASE(A4)
	BSR.B	_xfer
	ADDQ.W	#6,A7
	JSR	_dm_xfer
	JSR	_XferKeys(PC)
