...
L000FE:
	...
	MOVE.W	D4,D3
	MULU.W	#$0009,D3
	MOVE.W	D3,-$5154(A4)	;_p_row
	MOVE.W	-$77D0(A4),D3
	ADD.W	D3,-$5152(A4)	;_p_col
	MOVE.W	-$77D2(A4),D3
	ADD.W	D3,-$5154(A4)	;_p_row
	MOVEM.L	(A7)+,D4/D5
	UNLK	A5
	RTS
...
;_SetOffset
	MOVE.W	#$0007,-$77D0(A4)	;_Window2 + 50
	MOVE.W	#$0005,-$77D2(A4)	;_Window2 + 48
